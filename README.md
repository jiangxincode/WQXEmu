...
文曲星电子辞典模拟器，使用 Rust 编写，采用低级模拟 (LLE) 方式运行真实固件。目前支持 NC1020、PC1000 和 NC2000。

A Wenquxing electronic dictionary emulator written in Rust, using Low-Level Emulation (LLE) to run real firmware. NC1020, PC1000 and NC2000 are all supported.
...
- **Multi-model architecture** — shared `Machine` trait with NC1020 / PC1000 / NC2000 backends (PC1000 boots to the main menu with keyboard navigation and NOR Flash persistence)
